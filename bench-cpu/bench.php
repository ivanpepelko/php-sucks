...
// removed output buffer control, replaced with stderr
...
function hash2($n)
{
    ...
    $first = "foo_0";
    $last = "foo_" . ($n - 1);
    fwrite(STDERR, "$hash1[$first] $hash1[$last] $hash2[$first] $hash2[$last]\n");
}
...
function matrix($n)
{
    ...
    fwrite(STDERR, "{$mm[0][0]} {$mm[2][3]} {$mm[3][2]} {$mm[4][4]}\n");
}
